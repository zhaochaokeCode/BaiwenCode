									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php if(is_array($data)): foreach($data as $key=>$news): ?><tr>
														<!-- <td class="center">
															<label>
														...
														<td style="width:600px;"><?php echo (mb_substr(strip_tags(htmlspecialchars_decode($news["content"])),0,60,'utf-8')); ?></td>
														<td><?php echo ($news["author"]); ?></td>
														<td>
															<?php if($news["is_top"] == 1): ?><a href="javascript:void(0)" class="is_top" value="1" nid="<?php echo ($news["id"]); ?>"><font color="green">是</font></a>
															<?php else: ?>
															<a href="javascript:void(0)" class="is_top" value="0" nid="<?php echo ($news["id"]); ?>"><font color="red">否</font></a><?php endif; ?>
														</td>
														
														<td><?php echo ($news["name"]); ?></td>
														<td><?php echo (date("Y-m-d H:s:i",$news["createtime"])); ?></td>
														<!-- <td class="hidden-480"><?php echo ($notice["display"]); ?></td> -->
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/th_g/admin.php/News/mod/id/<?php echo ($news["id"]); ?>.html">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="/th_g/admin.php/News/del/id/<?php echo ($news["id"]); ?>.html">
															...
															<div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="/th_g/admin.php/News/mod/id/<?php echo ($news["id"]); ?>.html" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="/th_g/admin.php/News/del/id/<?php echo ($news["id"]); ?>.html" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
		...
		<script type="text/javascript">
			$(function(){
				$(".is_top").on("click",function(){
					...
					var nid = my.attr("nid");
					$.post("/th_g/admin.php/News/top_news",{id:nid,is_top:is_top},function(data){
						if(data){
							if(is_top==1){
								my.attr("value",0);
