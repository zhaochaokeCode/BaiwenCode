		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/15combo/admin.php/Rule/mod" method="post" class="form-horizontal" role="form">
						<input type="hidden" name="id" value="<?php echo ($rule['id']); ?>">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 控制器方法名 </label>

							<div class="col-sm-9">
								<input type="text" name="name"  value="<?php echo ($rule['name']); ?>" id="form-field-1" placeholder="控制器方法名" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 规则名 </label>

							<div class="col-sm-9">
								<input type="text" name="title" value="<?php echo ($rule['title']); ?>" id="form-field-1" placeholder="规则名" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="type" value="<?php echo ($rule['type']); ?>" id="form-field-1" placeholder="类型" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
