		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/th_g/admin.php/Commodity/mod" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
						<input type="hidden" name="id" value="<?php echo ($commodity["id"]); ?>">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 衍生品名称 </label>

							<div class="col-sm-9">
								<input type="text" name="name" id="form-field-1" placeholder="衍生品名称" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" value="<?php echo ($commodity["name"]); ?>" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="url" id="form-field-1" placeholder="链接地址" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" value="<?php echo ($commodity["url"]); ?>" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<input type="hidden" name="src" value="<?php echo ($commodity["src"]); ?>">
								<span><?php echo ($commodity["src"]); ?></span> <br>
								<img src="/th_g/Public/<?php echo ($commodity["src"]); ?>" alt="" width="100" height="100">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 是否前台显示 </label>

							<div class="col-sm-9">
								<input type="radio" value="1" name="is_top"
								<?php if($commodity["is_top"] == 1): ?>checked<?php endif; ?>
								>是 &nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" value="0" name="is_top"
								<?php if($commodity["is_top"] == 0): ?>checked<?php endif; ?>
								>否								
							</div>
						</div>
