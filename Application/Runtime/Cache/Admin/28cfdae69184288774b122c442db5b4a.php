		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/15combo/admin.php/Games/server_add" method="post" class="form-horizontal" role="form">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 服务器名称 </label>

							<div class="col-sm-9">
								<input type="text" name="s_name" id="form-field-1" placeholder="服务器名称" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" required/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
							<?php if(is_array($games)): foreach($games as $key=>$games): ?><input type="radio" name="g_id" value="<?php echo ($games["g_id"]); ?>" style="width:40px;" required/><?php echo ($games["g_name"]); endforeach; endif; ?>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<input class="btn btn-info" type="submit" name="sub" value="添加">
