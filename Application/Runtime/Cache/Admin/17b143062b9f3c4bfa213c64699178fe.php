					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									<a href="/15combo/admin.php/View/viewlist/type/职业.html">
										<i class="icon-double-angle-right"></i>
										职业视频
									</a>
								</li>
								<li>
									<a href="/15combo/admin.php/View/viewlist/type/攻略.html">
										<i class="icon-double-angle-right"></i>
										攻略视频
									</a>
								</li>
								<li>
									<a href="/15combo/admin.php/View/viewlist/type/天赋.html">
										<i class="icon-double-angle-right"></i>
										天赋视频
									</a>
								</li>
								<li>
									<a href="/15combo/admin.php/View/viewlist/type/副职业.html">
										<i class="icon-double-angle-right"></i>
										副职业视频
									</a>
								</li>
				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							...
							<a href="/15combo/admin.php/View/add">上传视频</a>
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
												...
												<?php if(is_array($data)): foreach($data as $key=>$info): ?><tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/15combo/admin.php/View/mod/id/<?php echo ($info["id"]); ?>.html">
																	<i class="icon-pencil bigger-130"></i>
																</a>
																<a class="red" href="/15combo/admin.php/View/del/id/<?php echo ($info["id"]); ?>.html">
