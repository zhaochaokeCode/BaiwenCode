					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									<a href="/15combo/admin.php/Pay/index.html">
										<i class="icon-double-angle-right"></i>
									    攻略管理
									</a>
								</li>
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/15combo/admin.php/Faq/add.html">
										<i class="icon-double-angle-right"></i>
										添加FAQ
									</a>
								</li>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/15combo/admin.php/Games/mod" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
						<input type="hidden" name="g_id" value="<?php echo ($games['g_id']); ?>">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 游戏名称 </label>

							<div class="col-sm-9">
								<input type="text" name="g_name" value="<?php echo ($games['g_name']); ?>" id="form-field-1" placeholder="游戏名称" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" required />
							</div>
						</div>

						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 游戏图标 </label>

							<div class="col-sm-9">
								<input type="file" name="g_img" value="<?php echo ($games["g_img"]); ?>" id="form-field-1" placeholder="LOGO" class="col-xs-10 col-sm-5" style="width:150px;" /><img src="/15combo/Public/<?php echo ($games["g_img"]); ?>" style="width:183px;height:66px;" required>
							</div>
						</div>
						...
						<!-- <div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="status" value="<?php echo ($games['status']); ?>" id="form-field-1" placeholder="管理" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="type" value="<?php echo ($games['type']); ?>" id="form-field-1" placeholder="类型" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div> -->
						<div class="form-group">
							...
							<div class="col-sm-9">
							    ...
							    <!-- 加载编辑器的容器 -->
							    <script id="container" name="g_desc" type="text/plain" style="height:300px;">
							        <?php echo ($games["g_desc"]); ?>
							    </script>
							    <!-- 配置文件 -->
							    <script type="text/javascript" src="/15combo/Public/admin/ue/ueditor.config.js"></script>
							    <!-- 编辑器源码文件 -->
							    <script type="text/javascript" src="/15combo/Public/admin/ue/ueditor.all.js"></script>
							    <!-- 实例化编辑器 -->
							    <script type="text/javascript">
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<input class="btn btn-info" type="submit" name="sub" value="修改游戏">
									<!-- <i class="icon-ok bigger-110"></i>
									编辑 -->
								</input>

								&nbsp; &nbsp; &nbsp;
								<a href="/15combo/admin.php/Games" class="btn">返回</a>
							</div>
						</div>
					</form>
