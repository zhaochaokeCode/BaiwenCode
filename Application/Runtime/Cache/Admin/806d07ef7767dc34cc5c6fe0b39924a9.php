									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php if(is_array($info)): foreach($info as $key=>$games): ?><tr>
														<td><?php echo ($games["g_id"]); ?></td>
														<td><?php echo ($games["g_name"]); ?></td>
														<!-- <td><?php echo ($games["status"]); ?></td> -->
														<td><img src="/15combo/Public/<?php echo ($games["g_img"]); ?>" style="width:60px;height:60px;"></td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/15combo/admin.php/Games/mod/g_id/<?php echo ($games["g_id"]); ?>.html">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="/15combo/admin.php/Games/del/g_id/<?php echo ($games["g_id"]); ?>.html">
															...
															<div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="/15combo/admin.php/Games/mod/id/<?php echo ($games["id"]); ?>.html" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="/15combo/admin.php/Games/del/id/<?php echo ($games["id"]); ?>.html" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
																		...
																		<li>
																			<a href="/15combo/admin.php/Games/addGroup/id/<?php echo ($games["id"]); ?>.html" class="tooltip-error" data-rel="tooltip" title="Edit">
																				<span class="blue">
																					<i class="icon-edit bigger-120"></i>
																				</span>
																			</a>
