		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/15combo/admin.php/Website/mod" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
					<input type="hidden" name="id" value="1">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 标题 </label>

							<div class="col-sm-9">
								<input type="text" name="title" value="<?php echo ($info[0]['title']); ?>" id="form-field-1" placeholder="标题" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="keyword" value="<?php echo ($info["0"]["keyword"]); ?>" id="form-field-1" placeholder="关键字" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="description" value="<?php echo ($info["0"]["description"]); ?>" id="form-field-1" placeholder="描述" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="copyright" value="<?php echo ($info["0"]["copyright"]); ?>" id="form-field-1" placeholder="版权" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="file" name="logo" value="<?php echo ($info["0"]["logo"]); ?>" id="form-field-1" placeholder="LOGO" class="col-xs-10 col-sm-5" style="width:150px;" /><img src="/15combo/Public/<?php echo ($info["0"]["logo"]); ?>" style="width:183px;height:66px;">
							</div>
						</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<!-- <i class="icon-ok"></i> -->
								<input class="btn btn-info" type="submit" name="sub" value="配置网站"></input>
								&nbsp; &nbsp; &nbsp;
