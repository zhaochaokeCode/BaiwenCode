					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									<a href="/15combo/admin.php/View/index.html">
										<i class="icon-double-angle-right"></i>
										视频列表
									</a>
								</li>
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/15combo/admin.php/guide/add.html">
										<i class="icon-double-angle-right"></i>
										添加引导
									</a>
								</li>
								<li>
									<a href="/15combo/admin.php/guide/index.html">
										<i class="icon-double-angle-right"></i>
										引导列表
									</a>
								</li>
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/15combo/admin.php/gift/add.html">
										<i class="icon-double	-angle-right"></i>
										添加cdkey
									</a>
								</li>
								<li>
									<a href="/15combo/admin.php/gift/index.html">
										<i class="icon-double-angle-right"></i>
										cdkey列表
									</a>
								</li>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/15combo/admin.php/Profession/modpro" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
						<input type="hidden" value="<?php echo ($data["id"]); ?>" name="id">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 职业名 </label>

							<div class="col-sm-9">
								<input type="text" name="name" id="form-field-1" placeholder="职业名" value="<?php echo ($data["name"]); ?>" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 武器 </label>

							<div class="col-sm-9">
								<input type="text" name="weapon" id="form-field-1" placeholder="武器" value="<?php echo ($data["weapon"]); ?>" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 特性 </label>

							<div class="col-sm-9">
								<input type="text" name="charater" id="form-field-1" placeholder="特性" value="<?php echo ($data["charater"]); ?>" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 门派属性 </label>
							<div class="col-sm-9">
								<select name="property" id="">
									<option value="<?php echo ($data["property"]); ?>"><?php echo ($data["property"]); ?></option>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 克制门派 </label>

							<div class="col-sm-9">
								<select name="restrain" id="">
									<?php if(is_array($profession)): foreach($profession as $key=>$info): ?><option value="<?php echo ($info["name"]); ?>"
										<?php if($info["name"] == $data['restrain'] ): ?>selected<?php endif; ?>
										><?php echo ($info["name"]); ?></option><?php endforeach; endif; ?>
								</select>
								
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 操作难度 </label>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<input type="hidden" name="old_cover" value="<?php echo ($data["cover"]); ?>">
								<img src="/15combo/Public/<?php echo ($data["cover"]); ?>" alt="" width="100" height="100">
							</div>
						</div>
						<div class="form-group">
							...
							<div id="birth" class="col-sm-9">
						   		...
						   		<?php echo ($data["view"]); ?>
						   		<input type="hidden" name="old_view" value="<?php echo ($data["view"]); ?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 技能小图标 </label>

							<div class="col-sm-9">
								<input type="file" name="icon">
								<input type="hidden" name="old_icon" value="<?php echo ($data["icon"]); ?>">
								<img src="/15combo/Public/<?php echo ($data["icon"]); ?>" alt=""  width="100" height="100">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea name="desc" id="" cols="44" rows="10"><?php echo ($data["desc"]); ?></textarea>
							</div>
						</div>
