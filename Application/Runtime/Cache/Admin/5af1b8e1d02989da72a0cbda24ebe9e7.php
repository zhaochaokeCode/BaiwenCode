				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							...
							<a href="/15combo/admin.php/Pay/add">添加新职业</a>
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php if(is_array($consumption)): foreach($consumption as $key=>$consumption): ?><tr>
														<!-- <td class="center">
															<label>
														...
														<td><?php echo ($consumption["t_id"]); ?></td>
														<td>
															<?php if($consumption["type"] == 1 ): ?><font color="green">平台币</font>
														    <?php else: ?>
														    <font color="red">游戏币</font><?php endif; ?>
														</td>
														<td><?php echo ($consumption["payment"]); ?></td>
														<td><?php echo ($consumption["bankid"]); ?></td>
														<td><?php echo ($consumption["g_name"]); ?></td>
														<td><?php echo ($consumption["s_name"]); ?></td>
														<td><?php echo ($consumption["nicename"]); ?></td>
														<td><?php echo ($consumption["payamount"]); ?></td>
														<td><?php echo ($consumption["before"]); ?></td>
														<td><?php echo ($consumption["after"]); ?></td>
														<td><?php echo ($consumption["createtime"]); ?></td>
														<!-- <td> -->
															<!-- <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons"> -->
																...
																<!-- <a class="green" href="/15combo/admin.php/Pay/mod/id/<?php echo ($consumption["id"]); ?>.html">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="/15combo/admin.php/Pay/del/id/<?php echo ($consumption["id"]); ?>.html">
															...
															<!-- <div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="/15combo/admin.php/Pay/mod/id/<?php echo ($consumption["id"]); ?>.html" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="/15combo/admin.php/Pay/del/id/<?php echo ($consumption["id"]); ?>.html" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
