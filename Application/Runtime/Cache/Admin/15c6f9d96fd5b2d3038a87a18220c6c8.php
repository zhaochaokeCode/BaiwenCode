				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							...
							<a href="/th_g/admin.php/Commodity/add">添加衍生品</a>
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php if(is_array($commodity)): foreach($commodity as $key=>$info): ?><tr>
														<td><?php echo ($info["id"]); ?></td>
														<td><?php echo ($info["name"]); ?></td>
														<td><img src="/th_g/Public/<?php echo ($info["src"]); ?>" alt="" width="50" height="50"></td>
														<td><a href="<?php echo ($info["url"]); ?>" target="view_window"><?php echo ($info["url"]); ?></a></td>
														<td><?php echo date('Y-m-d H:i:s',$info['time']);?></td>
														<td>
															<?php if($info["is_top"] == 1): ?><font color="green">是</font>
															<?php else: ?>
																<font color="red">否</font><?php endif; ?>
														</td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/th_g/admin.php/Commodity/mod/id/<?php echo ($info["id"]); ?>.html">
																	<i class="icon-pencil bigger-130"></i>
																</a>
																<a class="red" href="/th_g/admin.php/Commodity/del/id/<?php echo ($info["id"]); ?>.html">
