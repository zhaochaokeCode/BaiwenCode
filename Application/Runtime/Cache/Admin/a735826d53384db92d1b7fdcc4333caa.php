...
<!-- 							<a href="/th_g/admin.php/View/add">上传视频</a> &nbsp;
							<a href="/th_g/admin.php/View/index">全部视频</a> &nbsp;
							<a href="/th_g/admin.php/View/viewlist/type/职业.html">职业视频</a> &nbsp;
							<a href="/th_g/admin.php/View/viewlist/type/攻略.html">攻略视频</a> &nbsp;
							<a href="/th_g/admin.php/View/viewlist/type/天赋.html">天赋视频</a> &nbsp;
							<a href="/th_g/admin.php/View/viewlist/type/副职业.html">副职业视频</a> &nbsp; -->
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
												...
												<?php if(is_array($data)): foreach($data as $key=>$info): ?><tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/th_g/admin.php/View/mod/id/<?php echo ($info["id"]); ?>.html">
																	<i class="icon-pencil bigger-130"></i>
																</a>
																<a class="red" href="/th_g/admin.php/View/del/id/<?php echo ($info["id"]); ?>.html">
