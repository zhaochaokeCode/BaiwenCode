				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/admin.php/question.html">
										<i class="icon-double-angle-right"></i>
										用户反馈列表
									</a>
								</li>										
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<form action="/admin.php/Help/del" method="post">
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php if(is_array($help)): foreach($help as $key=>$help): ?><tr>
														<td class="center">
															<label>
																<input type="checkbox" name="ids[]" value="<?php echo ($help["id"]); ?>" class="ace" />
																<span class="lbl"></span>
															</label>
														</td>
														...
														<td><?php echo ($help["sort"]); ?></td>
														<td><?php echo ($help["accessory"]); ?></td>
														<td><?php echo ($help["uname"]); ?></td>
														<td><?php echo ($help["email"]); ?></td>
														<td><?php echo ($help["game"]); ?></td>
														<td><?php echo ($help["gameserver"]); ?></td>
														
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																

																<!-- <a class="green" href="/admin.php/Help/mod/id/<?php echo ($help["id"]); ?>.html">
																	<i class="icon-pencil bigger-130"></i>
																</a> -->

																<a class="red" href="/admin.php/Help/del/id/<?php echo ($help["id"]); ?>.html">
															...
															<div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		...
																		<!-- <li>
																			<a href="/admin.php/Help/mod/id/<?php echo ($help["id"]); ?>.html" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="/admin.php/Help/del/id/<?php echo ($help["id"]); ?>.html" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
