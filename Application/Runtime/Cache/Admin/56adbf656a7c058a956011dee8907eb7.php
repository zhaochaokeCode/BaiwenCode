		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/th_g/admin.php/View/addppro" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 图片标题 </label>

							<div class="col-sm-9">
								<input type="text" name="title" id="form-field-1" placeholder="图片标题" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" required/>
							</div>
						</div>

						<div class="form-group">	
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 图片类型 </label>

							<div class="col-sm-9">
								<input type="radio" name="type" value="-1" required>壁纸 &nbsp;
								<input type="radio" name="type" value="-2" required>真人秀 &nbsp;
								<input type="radio" name="type" value="-3" required>原画 &nbsp;
								<input type="radio" name="type" value="-4" required>表情包 &nbsp;
								<input type="radio" name="type" value="-5" required>同人 &nbsp;
							</div>
						</div>
