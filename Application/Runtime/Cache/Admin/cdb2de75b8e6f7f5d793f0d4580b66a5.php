		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/th_g/admin.php/View/modpro" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
					<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 视频标题 </label>

							<div class="col-sm-9">
								<input type="text" name="title" id="form-field-1" placeholder="视频标题" value="<?php echo ($data["title"]); ?>" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
...
<!-- 						<div class="form-group">	
							...
							<div class="col-sm-9">
								<input type="radio" name="type" value="职业" 
								<?php if($data["type"] == '职业'): ?>checked<?php endif; ?>
								>职业 &nbsp;
								<input type="radio" name="type" value="攻略"
								<?php if($data["type"] == '攻略'): ?>checked<?php endif; ?>
								>攻略 &nbsp; 
								<input type="radio" name="type" value="天赋"
								<?php if($data["type"] == '天赋'): ?>checked<?php endif; ?>
								>天赋 &nbsp;
								<input type="radio" name="type" value="副职业"
								<?php if($data["type"] == '副职业'): ?>checked<?php endif; ?>
								>副职业 &nbsp;
							</div>
						</div> -->
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<!-- <input type="hidden" name="view" value="<?php echo ($data["view"]); ?>"> -->
								<?php echo ($data["view"]); ?>
							</div>
						</div>
						<div class="form-group">
...
<!-- 								<input type="hidden" name="picture" value="<?php echo ($data["picture"]); ?>"> -->
								...
								<img src="/th_g/Public/<?php echo ($data["picture"]); ?>" alt="" width="200" height="150">
							</div>
						</div>
