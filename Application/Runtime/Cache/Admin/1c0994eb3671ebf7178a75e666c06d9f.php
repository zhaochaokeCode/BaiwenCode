				...
				<div class="sidebar" id="sidebar">
					...
					<div class="sidebar-shortcuts" id="sidebar-shortcuts">
						<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
							<button onclick="javascript:window.open('/15combo/Index.php');" class="btn btn-success"  title="访问网站首页">
								<i class="icon-home"></i>
							</button>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/15combo/admin.php/User/mod" method="post" class="form-horizontal" role="form">
					<div><input type="hidden" name="id" value="<?php echo ($user["id"]); ?>"></div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 登录名 </label>

							<div class="col-sm-9">
								<input type="text" name="loginname" value="<?php echo ($user["loginname"]); ?>"  id="form-field-1" placeholder="登录名" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="password" name="password" value="<?php echo ($user["password"]); ?>" id="form-field-1" placeholder="密码" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="password" name="repwd" value="<?php echo ($user["password"]); ?>" id="form-field-1" placeholder="确认密码" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="nicename" value="<?php echo ($user["nicename"]); ?>" id="form-field-1" placeholder="昵称" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="email" name="email" value="<?php echo ($user["email"]); ?>" id="form-field-1" placeholder="邮箱" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="radio" name="sex" value="0" <?php echo ($user['sex'] == 0 ? checked : ''); ?> style="width:40px;"/>男
								<input type="radio" name="sex" value="1" <?php echo ($user['sex'] == 1 ? checked : ''); ?> style="width:40px;"/>女
							</div>
						</div>
						<div class="form-group">
