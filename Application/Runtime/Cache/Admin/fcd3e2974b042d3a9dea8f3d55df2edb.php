									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php if(is_array($data)): foreach($data as $key=>$pic): ?><tr>
														<!-- <td class="center">
															<label>
														...
														<td><?php echo ($pic["image"]); ?></td>
														<td><?php echo ($pic["picurl"]); ?></td>
														<td><img src='/th_g/Public/<?php echo ($pic['image']); ?>' style="width:40px;height:40px"/></td>
														<td>
														<?php if($pic["state"] == 1): ?><a href="javascript:void(0)" class="state" value="1" nid="<?php echo ($pic["id"]); ?>"><font color="green">是</font></a>
														<?php else: ?>
														<a href="javascript:void(0)" class="state" value="0" nid="<?php echo ($pic["id"]); ?>"><font color="red">否</font></a><?php endif; ?>
														</td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/th_g/admin.php/Playpic/mod/id/<?php echo ($pic["id"]); ?>.html">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="/th_g/admin.php/Playpic/del/id/<?php echo ($pic["id"]); ?>.html">
																	<i class="icon-trash bigger-130"></i>
																</a>

																<!-- <a class="red" href="/th_g/admin.php/Playpic/url/id/<?php echo ($pic["id"]); ?>.html">
																	<i class="icon-trash bigger-130"></i>
																</a> -->
															</div>
															...
															<div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="/th_g/admin.php/Playpic/mod/id/<?php echo ($pic["id"]); ?>.html" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="/th_g/admin.php/Playpic/del/id/<?php echo ($pic["id"]); ?>.html" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
		...
		<script type="text/javascript">
			$(function(){
				$(".state").on("click",function(){
					...
					var nid = my.attr("nid");
					$.post("/th_g/admin.php/Playpic/state",{id:nid,state:state},function(data){
						if(data){
							if(state==1){
								my.attr("value",0);
