								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form class="mws-form" action="/th_g/admin.php/Login/login" method="post">
												<fieldset>
...
<![endif]-->
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='/th_g/Public/admin/js/jquery-1.10.2.min.js'>"+"<"+"/script>");
</script>
<![endif]-->
