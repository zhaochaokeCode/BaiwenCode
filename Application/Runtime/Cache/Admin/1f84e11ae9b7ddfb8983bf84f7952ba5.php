		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/th_g/admin.php/Hotspot/mod" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
					...
					<input type="hidden" value="<?php echo ($data["id"]); ?>" name="id">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="title" id="form-field-1" placeholder="标题" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" value="<?php echo ($data["title"]); ?>" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="url" id="form-field-1" placeholder="URL" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" value="<?php echo ($data["url"]); ?>"/>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="time" id="form-field-1" placeholder="发帖时间" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" value="<?php echo ($data["time"]); ?>" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="author" id="form-field-1" placeholder="作者名称" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" value="<?php echo ($data["author"]); ?>" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<input type="hidden" value="<?php echo ($data["pic"]); ?>" name="pic">
								<span><?php echo ($data["pic"]); ?></span>
								<img src="/th_g/Public/<?php echo ($data["pic"]); ?>" alt="" width="60" height="60">
							</div>
						</div>
