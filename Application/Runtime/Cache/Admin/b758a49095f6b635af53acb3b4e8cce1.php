					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									<a href="/admin.php/Pay/consumption.html">
										<i class="icon-double-angle-right"></i>
									    充值游戏列表
									</a>
								</li>
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/admin.php/help/index.html">
										<i class="icon-double-angle-right"></i>
										问题列表
									</a>
								</li>
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<?php if(is_array($consumption)): foreach($consumption as $key=>$consumption): ?><tr>
														...
														<td><?php echo ($consumption["source"]); ?></td>
														...
														<!-- <td> -->
															<!-- <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons"> -->
																...
																<!-- <a class="green" href="/admin.php/Pay/mod/id/<?php echo ($consumption["id"]); ?>.html">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="/admin.php/Pay/del/id/<?php echo ($consumption["id"]); ?>.html">
															...
															<!-- <div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="/admin.php/Pay/mod/id/<?php echo ($consumption["id"]); ?>.html" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="/admin.php/Pay/del/id/<?php echo ($consumption["id"]); ?>.html" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
