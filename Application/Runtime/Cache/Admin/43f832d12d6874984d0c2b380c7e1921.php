		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/15combo/admin.php/Talent/modpro" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
					<input type="hidden" name="id" value="<?php echo ($data["t_id"]); ?>">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 天赋名称 </label>

							<div class="col-sm-9">
								<input type="text" name="t_name" id="<form-field-1></form-field-1>" placeholder="天赋名称"  value="<?php echo ($data["t_name"]); ?>" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 所属门派 </label>

							<div class="col-sm-9">
								<select name="belong" id="">
								<?php if(is_array($profession)): foreach($profession as $key=>$info): ?><option value="<?php echo ($info["id"]); ?>"
									<?php if($info["id"] == $data['belong'] ): ?>selected<?php endif; ?>
									><?php echo ($info["name"]); ?></option><?php endforeach; endif; ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 天赋图标 </label>

							<div class="col-sm-9">
								<input type="file" name="t_icon">
								<input type="hidden" value="<?php echo ($data["t_icon"]); ?>">
								<img src="/15combo/Public/<?php echo ($data["t_icon"]); ?>" alt="" width="100" height="100">
							</div>
						</div>
						<div class="form-group">
							...
							<div id="birth" class="col-sm-9">
						   		<input type="file" name="t_view">
						   		<input type="hidden" name="t_view" value="<?php echo ($data["t_view"]); ?>">
						   		<?php echo ($data["t_view"]); ?>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea name="t_desc" id="" cols="44" rows="10"><?php echo ($data["t_desc"]); ?></textarea>
							</div>
						</div>
