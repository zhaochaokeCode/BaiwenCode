												...
												<?php if(is_array($data)): foreach($data as $key=>$news): ?><tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/15combo/admin.php/Raiders/mod/id/<?php echo ($news["id"]); ?>.html">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="/15combo/admin.php/Raiders/del/id/<?php echo ($news["id"]); ?>.html">
															...
															<div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="/15combo/admin.php/Raiders/mod/id/<?php echo ($news["id"]); ?>.html" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="/15combo/admin.php/Raiders/del/id/<?php echo ($news["id"]); ?>.html" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
		...
		<script type="text/javascript">
			$(function(){
				$(".is_top").on("click",function(){
					...
					var nid = my.attr("nid");
					$.post("/15combo/admin.php/Raiders/top_news",{id:nid,is_top:is_top},function(data){
						if(data){
							if(is_top==1){
								my.attr("value",0);
