		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/admin.php/Raiders/mod" method="post" class="form-horizontal" role="form">
						<div><input type="hidden" name="id" value="<?php echo ($news["id"]); ?>"></div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 标题 </label>

							<div class="col-sm-9">
								<input type="text" name="title" value="<?php echo ($news["title"]); ?>" id="form-field-1" placeholder="标题" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select class="form-control" id="form-field-select-1" name="type" style="width:450px;">
									<option value="<?php echo ($news["type"]); ?>"><?php echo ($news["type"]); ?></option>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<select class="form-control" id="form-field-select-1" name="belong" style="width:450px;">
									<option value="<?php echo ($news["belong"]); ?>"><?php echo ($news["g_name"]); ?></option>
									<?php if(is_array($games)): foreach($games as $key=>$games): ?><option value="<?php echo ($games["g_id"]); ?>"><?php echo ($games["g_name"]); ?></option><?php endforeach; endif; ?>
