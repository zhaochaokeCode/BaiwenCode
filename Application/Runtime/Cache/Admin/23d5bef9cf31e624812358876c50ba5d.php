		...
		<div class="page-content">
			...
			<div class="row">
				...
				<table>
					...
					<tr>
						<td>问题分类:</td>
						<td><?php echo ($data["q_type"]["0"]); ?> - <?php echo ($data["q_type"]["1"]); ?> </td>
						<td></td>
						<td></td>
					</tr>
					<tr>
						<td>所用浏览器:</td>
						<td><?php echo ($data["u_browser"]); ?></td>
						<td>OS:</td>
						<td><?php echo ($data["os"]); ?></td>
					</tr>
					<tr>
						<td>发生时间:</td>
						<td><?php echo (date("Y-m-d H:i",$data["q_time"])); ?></td>
						<td>提交时间:</td>
					...
					<tr>
						<td colspan = "4">内容: <br><textarea name="" id="" cols="60" rows="10" border="0"><?php echo ($data["content"]); ?></textarea></td>
						<td></td>
						<td></td>
						<td></td>
					</tr>
					<tr>
						<td colspan = "4">
						<?php if($data["q_img"] != ''): ?>附件: <br><img src="/Public/<?php echo ($data["q_img"]); ?>" alt="" width="450" height="200"><?php endif; ?>
						</td>
					</tr>
				</table>
				<a href="/admin.php/Question/index" ><button class="btn">返回</button></a>
				</center>	
