...
<!-- 								<li>
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
							<a href="/th_g/admin.php/Hotspot/add/type/p">添加图片热点</a>
								<!-- PAGE CONTENT BEGINS -->
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<?php if(is_array($data)): foreach($data as $key=>$pic): ?><tr>
														...
														<td><img src="/th_g/Public/<?php echo ($pic["pic"]); ?>" style="width:60px;height:60px;"></td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/th_g/admin.php/Hotspot/mod/id/<?php echo ($pic["id"]); ?>/type/p.html">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="/th_g/admin.php/Hotspot/del/id/<?php echo ($pic["id"]); ?>/type/p.html">
