		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/th_g/admin.php/Guide/addpro" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 引导标题 </label>

							<div class="col-sm-9">
								<input type="text" name="title" id="form-field-1" placeholder="新闻标题" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" required/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								...
								<input type="radio" name="type" value="9" style="width:40px;" required />新手
								<input type="radio" name="type" value="10" style="width:40px;" required />灵偶
								<input type="radio" name="type" value="11" style="width:40px;" required />玩法
								<input type="radio" name="type" value="12" style="width:40px;" required />斗法
							</div>
						</div>
<!-- 						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								&nbsp;&nbsp;&nbsp;<input type="radio" name="is_top" value="1" required>是
								&nbsp;&nbsp;&nbsp;<input type="radio" name="is_top" value="0" required>否
							</div>
						</div>
						<!-- <div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
							    ...
							    <!-- 配置文件 -->
							    <script type="text/javascript" src="/th_g/Public/admin/ue/ueditor.config.js"></script>
							    <!-- 编辑器源码文件 -->
							    <script type="text/javascript" src="/th_g/Public/admin/ue/ueditor.all.js"></script>
							    <!-- 实例化编辑器 -->
							    <script type="text/javascript">
