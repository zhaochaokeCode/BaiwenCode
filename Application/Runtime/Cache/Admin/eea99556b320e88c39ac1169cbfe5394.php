...
<!-- 								<li>
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
							<a href="/th_g/admin.php/Hotspot/add/type/t">添加文字热点</a>
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php if(is_array($data)): foreach($data as $key=>$text): ?><tr>
														<td><?php echo ($text["id"]); ?></td>
														<td><?php echo ($text["title"]); ?></td>
														<td><?php echo ($text["url"]); ?></td>
														<td><?php echo ($text["author"]); ?></td>
														<td><img src="/th_g/Public/<?php echo ($text["pic"]); ?>" style="width:60px;height:60px;"></td>
														<td><?php echo ($text["time"]); ?></td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/th_g/admin.php/Hotspot/mod/id/<?php echo ($text["id"]); ?>/type/t.html">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="/th_g/admin.php/Hotspot/del/id/<?php echo ($text["id"]); ?>/type/t.html">
															...
															<div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="/th_g/admin.php/Hotspot/mod/id/<?php echo ($admin["id"]); ?>.html" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="/th_g/admin.php/Hotspot/del/id/<?php echo ($admin["id"]); ?>.html" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
																		...
																		<li>
																			<a href="/th_g/admin.php/Hotspot/addGroup/id/<?php echo ($admin["id"]); ?>.html" class="tooltip-error" data-rel="tooltip" title="Edit">
																				<span class="blue">
																					<i class="icon-edit bigger-120"></i>
																				</span>
																			</a>
