		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/15combo/admin.php/Assistant/modpro" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
					<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 副职业名称 </label>

							<div class="col-sm-9">
								<input type="text" name="name" id="form-field-1" placeholder="副职业名称" value="<?php echo ($data["name"]); ?>" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<img src="/15combo/Public/<?php echo ($data["img"]); ?>" alt="" width="100" height="100">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<input type="hidden" value="<?php echo ($data["view"]); ?>">
								<?php echo ($data["view"]); ?>
							</div>
						</div>
<!-- 
						<div class="form-group">
							...
							<div class="col-sm-5">
								...
								<input type="radio" name="type" value="通知" style="width:40px;"/>公告
								<input type="radio" name="type" value="活动" style="width:40px;"/>活动
								<input type="radio" name="type" value="维护" style="width:40px;"/>新闻
							</div>
						</div> -->
<!-- 						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 副职业介绍 </label>
							<div class="col-sm-9">

								<div class="form-group" style="width:700px; padding-left:9px;">
							    <!-- 加载编辑器的容器 -->
							    <script id="container" name="desc" type="text/plain" style="height:300px;">
							       <?php echo ($data["desc"]); ?>
							    </script>
							    <!-- 配置文件 -->
