	...
	<div class="main-content">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form action="/th_g/admin.php/Playpic/domod" method="post"  class="form-horizontal" enctype="multipart/form-data">
						<div style="margin: 0 100px;margin-top:20px">
							<img src="/th_g/Public/<?php echo ($data['image']); ?>" style="width:600px"/>
					    ...
					    <div class="form-group">
							...
							<div class="col-sm-9">
								<input type="radio" name="state" value="1"  style="width:40px;" 
								<?php if($data["state"] == 1): ?>checked<?php endif; ?>
								/>启用
								<input type="radio" name="state" value="0"  style="width:40px;" 
								<?php if($data["state"] == 0): ?>checked<?php endif; ?>
								/>停用
							</div>
						</div>
					  	<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="picurl" id="form-field-1" placeholder="以http://开头添加链接地址" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" value="<?php echo ($data["picurl"]); ?>"/>
							</div>
						</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<input class="btn btn-info" type="submit" name="submit" value="修改"></input>
							</div>
						</div>
					</form>
