				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							...
							<a href="/th_g/admin.php/Profession/add">添加新职业</a>
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php if(is_array($profession)): foreach($profession as $key=>$info): ?><tr>
														<td><?php echo ($info["id"]); ?></td>
														<td><?php echo ($info["name"]); ?></td>
														<td><?php echo ($info["desc"]); ?></td>
														<td><?php echo ($info["property"]); ?></td>
														<td><?php echo ($info["restrain"]); ?></td>
														<td><?php echo ($info["weapon"]); ?></td>
														<td><?php echo ($info["charater"]); ?></td>
														<td><?php echo ($info["difficulty"]); ?></td>
														<td><img src="/th_g/Public/<?php echo ($info["cover"]); ?>" alt="" width="100" height="100"></td>
														<td><a href="/th_g/admin.php/public/view?src=<?php echo ($info["view"]); ?>">点击查看</a></td>
														<td><img src="/th_g/Public/<?php echo ($info["icon"]); ?>" alt="" width="100" height="100"></td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/th_g/admin.php/Profession/mod/id/<?php echo ($info["id"]); ?>.html">
																	<i class="icon-pencil bigger-130"></i>
																</a>
																<a class="red" href="/th_g/admin.php/Profession/del/id/<?php echo ($info["id"]); ?>.html">
