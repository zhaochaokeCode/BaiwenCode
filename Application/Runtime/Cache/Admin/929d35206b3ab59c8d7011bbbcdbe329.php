		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/15combo/admin.php/Strategy/modpro" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
					<input type="hidden" name="id" value="<?php echo ($data["id"]); ?>">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 攻略标题 </label>

							<div class="col-sm-9">
								<input type="text" name="title" id="form-field-1" placeholder="攻略标题" value="<?php echo ($data["title"]); ?>" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
<!-- 
						<div class="form-group">
...
<!-- 						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 攻略内容 </label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<input type="hidden" value="<?php echo ($data["adjunct"]); ?>" name="adjunct">
								<?php echo ($data["adjunct"]); ?>
							</div>
						</div>
