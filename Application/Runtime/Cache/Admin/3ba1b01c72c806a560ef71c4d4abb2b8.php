		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/admin.php/Faq/mod" method="post" class="form-horizontal" role="form">
						<div><input type="hidden" name="id" value="<?php echo ($faq["id"]); ?>"></div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> FAQ标题 </label>

							<div class="col-sm-9">
								<input type="text" name="title" value="<?php echo ($faq["title"]); ?>" id="form-field-1" placeholder="FAQ标题" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
							<textarea name="content" class="form-control" id="form-field-8" placeholder="FAQ内容......" style="margin-top: 0px; margin-bottom: 0px; height: 150px; width:350px;"><?php echo ($faq["content"]); ?></textarea>
							</div>
						</div>
