					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										<form action="/15combo/admin.php/Question/del" method="post">
										...
										<div class="table-responsive">
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<?php if(is_array($data)): foreach($data as $key=>$info): ?><tr>
														<td class="center">
															<label>
																<input type="checkbox" name="id[]" class="ace" value="<?php echo ($info["q_id"]); ?>" />
																<span class="lbl"></span>
															</label>
														</td>
														<td><?php echo ($info["q_id"]); ?></td>
														<td><?php echo ($info["nicename"]); ?></td>
														<td><?php echo ($info["u_email"]); ?></td>
														<td><?php echo ($info["g_name"]); ?></td>
														<td><?php echo ($info["s_name"]); ?></td>
														<td><?php echo ($info["r_name"]); ?></td>
														<td><?php echo ($info["q_type"]); ?></td>
														<td><?php echo ($info["u_browser"]); ?></td>
														<td><?php echo ($info["os"]); ?></td>
														<td><?php echo (date("Y-m-d H:i",$info["q_time"])); ?></td>
														<td><?php echo ($info["communication"]); ?></td>
														<td><?php echo (date("Y-m-d H:i:s",$info["create_time"])); ?></td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/15combo/admin.php/Question/show/id/<?php echo ($info["q_id"]); ?>.html" title="查看">
																	<i class="icon-zoom-in bigger-130"></i>
																</a>

																<!-- <a class="green" href="/15combo/admin.php/Question/mod/id/<?php echo ($consumption["id"]); ?>.html" title="编辑">
																	<i class="icon-pencil bigger-130"></i>
																</a> -->

																<a class="red" href="/15combo/admin.php/Question/del/id/<?php echo ($info["q_id"]); ?>.html" title="删除">
															...
															<!-- <div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="/15combo/admin.php/Question/mod/id/<?php echo ($consumption["id"]); ?>.html" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
																		...
																		<li>
																			<a href="/15combo/admin.php/Question/del/id/<?php echo ($info["id"]); ?>.html" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
