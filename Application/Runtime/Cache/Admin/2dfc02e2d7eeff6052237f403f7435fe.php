		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/th_g/admin.php/News/add" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								...
								<input type="radio" name="type" value="5" style="width:40px;" required/>新闻
								<input type="radio" name="type" value="6" style="width:40px;" required/>公告
								<input type="radio" name="type" value="7" style="width:40px;" required/>活动
								<input type="radio" name="type" value="8" style="width:40px;" required/>媒体
							</div>
						</div>
<!-- 						<div class="form-group">
