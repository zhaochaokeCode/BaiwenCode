		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/15combo/admin.php/Talent/addpro" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1" > 天赋名称 </label>

							<div class="col-sm-9">
								<input type="text" name="t_name" id="form-field-1" placeholder="天赋名称" class="col-xs-10 col-sm-5" style="margin-top: 0px; margin-bottom: 0px; width:350px;" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<?php if(is_array($profession)): foreach($profession as $key=>$info): ?><option value="<?php echo ($info["id"]); ?>"><?php echo ($info["name"]); ?></option><?php endforeach; endif; ?>
								</select>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<textarea name="t_desc" id="" cols="44" rows="10"></textarea>
							</div>
						</div>
