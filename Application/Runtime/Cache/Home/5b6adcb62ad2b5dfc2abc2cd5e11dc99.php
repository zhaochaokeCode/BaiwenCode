...
<div id="wrap">
    ...
    <div id="container" style=" margin-top:25px !important;">
            <!-- content -->
            <?php if(!empty($_SESSION['userinfo']['loginname'])){ echo "<script>alert('您已登录,要重新登录请先退出!');location.href='/index.php/Index'</script>";}else{ ?>
            <div id="content">
                    <div class="hydl_box">
                         ...
                         <div class="hydl_right" style="margin:0 auto; float:none;">
                               ...
                               <table>
                                   ...
                                   <tr>
                                      <td><p href="#" class="yzm" id="captcha-container"><img src="/index.php/Login/code" alt=""/></p><a href="javascript:void(0)" id="captcha"><img src="/Public/home/images/img_21.jpg" width="33" height="32" alt=""/></a></td>
                                     <td rowspan="2"></td>
                                   </tr>
                                   <tr>
...
$(function(){
  ...
  $('#code').blur(function(){
    ...
    // $.post('/index.php/Login/jscode',{'code':code},function(data){
    //   if(data==1){
    //       $('.code').html('验证码错误');
    //       $('.code').css({'color':'red','fontSize':'12px'});
  ...
  $('#reg').click(function(){
    ...
    $.post('/index.php/Login/dologin',{'loginname':loginname,'password':password,'code':code},function(data){
      if(data==1){
        // alert('注册成功');
