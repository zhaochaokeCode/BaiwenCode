...
<div id="wrap">
    ...
    <div id="container" style=" margin-top:25px !important;">
            <!-- content -->
            <?php if($_SESSION['isLog'] == 2 || !empty($_SESSION['userinfo']['loginname'])){ echo "<script>alert('您已登录,请先退出!');location.href='/gamenoll.com/index.php/Index'</script>";}else{ ?>
            <div id="content">
                    <div class="hydl_box">
                         <p class="tt_box">设置新密码</p>
                         ...
                         <form action="/gamenoll.com/index.php/Login/newPassword" method="post">
                         <div class="hydl_right" style="margin:0 auto; float:none;">
                               <p class="tt_12">设置新密码</p>
                               <table>
                                   <tr>
                                      <td>新密码</td>
                                   ...
                                   <tr>
                                      <td>确认新密码</td>
                                      <td><input type="password" name="repwd" id="repwd" onfocus="javascript:if(this.value=='PASSWORD')this.value='';" style=" width:165px; height:30px; line-height:30px; color:#cdd1d9; border:#cdd1d9 1px solid;"></td>
                                      <td>&nbsp;<span class="repwd" style="color:red;font-size:12px;"></span></td>
                                   </tr>
...
$(function(){
  ...
  $('input[type=password]').blur(function(){
    if($(this).is('#password')){
      if($(this).val()==''){ 
        $('.password').html('请输入新密码');
        $('.password').css({'color':'red','fontSize':'12px'});
      }else{
        $('.password').html('新密码已输入');
