		...
		<div class="content">
			<div class="contentArea beCenter">
				<div class="contentBar">
					<div class="contentBarModule">
						...
						<div class="contentBarCode">
							<img src="/th_g/Public/home/images/sys.png"/>
							<!-- 扫一扫下载游戏 -->
						</div>
					</div>
					<div class="contentBarModule">
				...
				<div class="contentTitleArea beCenter">
					<a href="/th_g/index.php/News/index/pageId/<?php echo ($_GET['page']); ?>/where/<?php echo ($_GET['where']); ?>"><img class="beBack" src="/th_g/Public/home/images/fanhui.png" /></a>
