    ...
    <div class="sanClist_top">
            ...
            <div class="sanClist fl">
              ...
              <div class="clear"></div>
                ...
                <?php if(is_array($data)): foreach($data as $key=>$news): if($news["is_top"] == 1): ?><li class="top_notice">
                    <?php else: ?>
                        <li><?php endif; ?>
                        <a href="/index.php/Exnews/details/id/<?php echo ($news["id"]); ?>"><?php echo ($news["title"]); ?><span><?php echo ($news["createtime"]); ?></span></a></li><?php endforeach; endif; ?>
        ...
        <?php else: ?>
            ...
            <div class="sanC_4 fr">
                ...
                <a href="sdfsdf" target="_blank"><img src="/Public/home/images/hajime_button.jpg" width="275" height="87" /></a>
            </div>
            <div class="clear"></div>
      </div>
    </div>
